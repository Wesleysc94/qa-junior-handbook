...
## Pitch dos seus projetos

Este capítulo amarra os projetos do portfólio em fala de entrevista. O grande objetivo é transformar código, bugs, pipeline e README em narrativa curta, segura e coerente sobre o que você sabe fazer e por que tomou certas decisões. Em QA júnior, o ganho real aparece quando você consegue reconhecer esse assunto no backlog, na conversa de refinement, na escolha do cenário de teste e no momento de comunicar risco para o time. Em vez de decorar uma definição isolada, a meta é entender o efeito prático que ela tem sobre cobertura, prioridade, confiança do release e qualidade da comunicação.

Boa narrativa tem começo, meio e fim. Sinais ruins aparecem quando a explicação pula de ferramenta em ferramenta sem dizer por que aquilo importou para qualidade do produto. Esse é o tipo de leitura que diferencia uma pessoa que só executa passo a passo de alguém que começa a pensar como profissional de qualidade. Quando o conceito fica claro, você passa a observar o produto de forma mais estruturada e deixa de depender apenas de feeling.

## Por que isso importa no mercado brasileiro

No mercado brasileiro, muita pessoa boa tecnicamente perde força na conversa porque descreve projeto como lista de ferramenta. Recrutador quer entender objetivo, estratégia, decisão, bug encontrado, aprendizado e impacto percebido. Em muitas empresas brasileiras, o time de QA ainda é enxuto e precisa trabalhar com tempo curto, pressão de entrega e processos em amadurecimento. Nessa realidade, dominar perguntas de recrutador não é luxo acadêmico; é uma forma concreta de reduzir retrabalho, dar feedback mais rápido e escolher melhor onde vale investir energia.
...
Quando Wesley fala do Toolshop e do Swag Lab, o ideal é ligar produto-alvo, camada de cobertura, decisão de stack, pipeline, bug conhecido e recomendação de release em respostas de 30 segundos, 60 segundos e 2 minutos. Repare que o valor do exemplo não está só no defeito encontrado ou no teste que passou. O valor está no encadeamento: hipótese, execução, evidência, decisão e acompanhamento. Esse encadeamento é o que transforma uma atividade pontual em prática profissional de QA.
...
Boa narrativa tem começo, meio e fim. Sinais ruins aparecem quando a explicação pula de ferramenta em ferramenta sem dizer por que aquilo importou para qualidade do produto. Bons QAs aprendem a perceber esses sinais cedo, antes que o problema vire retrabalho caro ou defeito em produção. Isso vale tanto para fluxo manual quanto para API, automação, CI/CD e comportamento do time.
...
Mesmo um outline em markdown já ajuda a treinar o pitch até ele ficar natural. O objetivo é sair do capítulo com um entregável tangível: algo que você possa anexar em issue, colocar no README do projeto ou usar como referência quando precisar repetir o raciocínio em outro contexto.

O foco não é decorar; é ganhar segurança para contar uma história técnica com começo e fim. Quando você transforma conhecimento em artefato, fica mais fácil revisar, explicar em entrevista e provar que domina o tema com evidência em vez de discurso genérico.

## Erros comuns de iniciante

Erro comum: responder “usei Playwright, pytest e GitHub Actions” sem conectar ferramenta a risco e decisão. Outro erro é falar só do caminho feliz e esconder o que deu errado. O primeiro erro clássico é tratar o assunto como receita pronta e tentar aplicar a mesma solução em qualquer sistema. Produto, time, risco e maturidade de processo mudam; por isso, a mesma prática precisa ser adaptada ao contexto.
...
A melhor resposta é a que liga ferramenta, risco, evidência e decisão. Isso mostra maturidade muito maior do que tentar soar “super técnico” sem narrativa. Em entrevista, a melhor resposta quase nunca é a mais longa; é a mais conectada com cenário real. Explique em voz alta como você perceberia o problema, que decisão tomaria primeiro e que evidência mostraria para sustentar a sua recomendação.
...
<Quiz
  id="perguntas-recrutador-q1"
  question="O que mais fortalece a resposta sobre projeto em entrevista?"
  options={[
  ...
  correctIndex={1}
  explanation="Projeto forte em entrevista é explicado como narrativa técnica: contexto, estratégia, evidência, decisão e aprendizado."
/>
