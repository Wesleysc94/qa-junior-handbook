...
Você pode seguir a trilha linear (recomendado no começo) ou pular direto para o módulo que precisa no dia — API antes de E2E, por exemplo. Marque os checkpoints, faça os quizzes e use os flashcards do glossário para revisão espaçada. Agora cada módulo de 1 a 8 também fecha com uma missão guiada curta, pensada para decisão por toque e revisão no celular. O progresso, favoritos, fila de revisão e última leitura ficam só no seu navegador (localStorage), sem backend.
...
- Uma rotina de estudo pessoal com missões guiadas, foco e revisão inteligente no navegador.
...
<div className="not-prose my-6 space-y-3 rounded-xl border border-fd-border bg-fd-card p-4">
  <p className="text-sm text-fd-muted-foreground">
    Capítulos rastreados: {TOTAL_CHAPTERS} · Quizzes finais: {TOTAL_QUIZZES} · Missões guiadas: {TOTAL_MISSIONS}.
  </p>
